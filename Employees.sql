...
SELECT COUNT(*) FROM ph_emp.dept_emp
WHERE to_date = '9999-01-01';
--240124

SELECT to_date FROM ph_emp.dept_emp
GROUP BY to_date
ORDER BY to_date DESC

--update dept_emp table from year 9999 to 1999
/*UPDATE ph_emp.dept_emp
SET to_date = '1999-01-01'
WHERE to_date = '9999-01-01';
--240124*/

SELECT * FROM ph_emp.dept_manager

SELECT COUNT(*) FROM ph_emp.dept_manager
WHERE to_date = '9999-01-01';
--9

--update dept_manager table from year 9999 to 1999
/*UPDATE ph_emp.dept_manager
SET to_date = '1999-01-01'
WHERE to_date = '9999-01-01';*/
...
--update title table from year 9999 to 1999
/*UPDATE ph_emp.title
SET to_date = '1999-01-01'
WHERE to_date = '9999-01-01';*/
--240124
